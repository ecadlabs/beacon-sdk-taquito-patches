...
Substrate blockchain support package for the Beacon SDK.

This is an add-on package in the ECAD-maintained Beacon SDK line. Most consumers get it transitively through higher-level Beacon packages.
