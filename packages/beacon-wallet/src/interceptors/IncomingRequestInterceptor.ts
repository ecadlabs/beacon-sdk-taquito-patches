...
import { AppMetadataManager, Logger } from '@ecadlabs/beacon-core'
import { SimulatedProofOfEventChallengeRequestOutput } from '@ecadlabs/beacon-types/dist/esm/types/beacon/messages/BeaconRequestOutputMessage'
